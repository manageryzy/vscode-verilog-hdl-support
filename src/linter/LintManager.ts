  ...
  async RunLintTool() {
    ...
    // window.showErrorMessage("Verilog-HDL/SystemVerilog: No Verilog document opened");
      ...
      switch (linterStr.label) {
        case "iverilog":
          tempLinter = new IcarusLinter(this.logger);
          break;
        case "xvlog":
          tempLinter = new XvlogLinter(this.logger);
          break;
        case "modelsim":
          tempLinter = new ModelsimLinter(this.logger);
          break;
        case "verilator":
          tempLinter = new VerilatorLinter(this.logger);
          break;
        default:
          return;
      }
